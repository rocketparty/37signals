...
//------------------------------------------------
    ...
    function update_person() {
        return($this->request('people/' . $id . '.xml?' . $updateValues, "PUT");
    }
